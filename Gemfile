...
gem 'actionmailer', '6.1.7.4' # Rails. Send email.
gem 'actionpack', '6.1.7.4' # Rails. MVC framework.
...
gem 'railties', '6.1.7.4' # Rails. Rails core, loads rest of Rails
...
group :development do
  ...
  gem 'rails', '6.1.7.4' # Rails (our web framework)
