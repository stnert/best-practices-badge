...
gem 'actionmailer', '6.1.7.5' # Rails. Send email.
gem 'actionpack', '6.1.7.5' # Rails. MVC framework.
gem 'actionview', '6.1.7.5' # Rails. View.
gem 'activejob', '6.1.7.5' # Rails. Async jobs.
gem 'activemodel', '6.1.7.5' # Rails. Model basics.
gem 'activerecord', '6.1.7.5' # Rails. ORM and query system.
# gem 'activestorage' # Not used. Attaches cloud files to ActiveRecord.
gem 'activesupport', '6.1.7.5' # Rails. Underlying library.
...
gem 'puma', '6.3.1' # Faster webserver; recommended by Heroku
...
gem 'railties', '6.1.7.5' # Rails. Rails core, loads rest of Rails
...
group :development, :test do
  ...
  gem 'bullet', '7.0.3' # Avoid n+1 queries
...
group :development do
  ...
  gem 'rails', '6.1.7.5' # Rails (our web framework)
